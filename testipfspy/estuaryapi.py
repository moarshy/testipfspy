# AUTOGENERATED! DO NOT EDIT! File to edit: ../02_estuaryapi.ipynb.
...
# %% ../02_estuaryapi.ipynb 3
import requests
from .utils import parse_response

# %% ../02_estuaryapi.ipynb 4
def est_get_viewer(
